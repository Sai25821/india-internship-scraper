                    ...
                    try:
                        ...
                        if title_elem:
                            ...
                            internship = {
                                ...
                                'Link': (
                                    f"https://internshala.com{link_elem['href']}"
                    ...
                    try:
                        ...
                        if title_elem:
                            ...
                            internship = {
                                ...
                                'Company': company_elem.get_text(strip=True) if company_elem else 'N/A',
                                'Location': (
                                    location_elem.get_text(strip=True) if location_elem else 'India'
                                ),
                                'Stipend': 'Check Link',
                                'Link': (
                                    f"https://in.indeed.com/viewjob?jk={job_id}" if job_id else 'N/A'
                                ),
                                'Source': 'Indeed India',
                                'Date': datetime.now().strftime('%Y-%m-%d'),
                                'Category': query,
